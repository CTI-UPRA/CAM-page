...
.dropdown:hover .dropbtn {
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/dreamstime_xl_50247533.jpg);">
	 ...
	 <!--Container con información de contacto y encasillados para enviar un mensaje-->
			...
			<div class="row">
				<div class="col-md-7 animate-box">
					...
					<div class="fh5co-contact-info">
						<h3>Dirección</h3>
                        <p>Para más información consiguenos a través de:</p>
						<ul>
							<li class="address">Km. 0.8, PR-653, Arecibo, 00612</li>
							<li class="phone"><a href="tel:7878150000,3306">(787) 815-0000 ext. 3300</a></li>
						</ul>

                        <!--<h2>Mapa</h2>-->
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.344622420343!2d-66.74264508526427!3d18.46804268743962!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf81fe612f4f1f3f7!2sUniversidad+de+Puerto+Rico+-+Arecibo!5e0!3m2!1sen!2spr!4v1479742304261" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                ...
                <div class="col-md-5 animate-box">
					...
					<form role="form" method="post" action="" enctype="multipart/form-data">
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="fname" name="name" class="form-control" placeholder="Nombre">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" name="message" cols="30" rows="10" class="form-control" placeholder="Mensaje"></textarea>
							</div>
						</div>
                    ...
                    <!--Validación de información por medio de php -->
					<?php
						...
						if(isset($_POST['submit'])) {
							...
							if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
								if(mail($to, $subject, $message,$headers) and mail($email, $subject, $message,$headers)) {
									echo '<div class="alert alert-success">Su mensaje ha sido enviado.</div>';
								} else {
									echo '<div class="alert alert-danger">Su mensaje no pudo ser enviado.</div>';
								}
							} else {
								echo '<div class="alert alert-danger">Escriba un email valido.</div>';
							}
