...
<html>
	...
	<title>CAM &mdash; Contact Us</title>
					...
					<form role="form" method="post" action="" enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" name="message" cols="30" rows="10" class="form-control" placeholder="Message"></textarea>
							</div>
						</div>
						...
						if(isset($_POST['submit'])) {
							...
							if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
								if(mail($to, $subject, $message,$headers) and mail($email, $subject, $message,$headers)) {
									...
									echo '<div class="alert alert-danger">Your message wasnt sent.</div>';
								}
							} else {
			...
			<div class="row row-pb-md">
				...
				<div id="copyright" class="container">
				        <div style="text-align: center">
							<p>&copy; Copyright 2017 MAC, <a href="contact.php">Webmaster: Leilanie Morales</a></p>
