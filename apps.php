			...
			<div class="row">
                ...
                <br>
                        ...
                        <div class="row">
                            <div style="text-align: center">
                                    <div style="text-align: center">
                                    <p>Pregunta Lobo es el asistente virtual de la comunidad de UPRA <br> donde los usuarios pueden obtener información relacionada a UPRA <br>mediante una interfaz de lenguaje natural, <br>en adición a un mapa interactivo con información <br> de cada localización y una lista informativa <br>de las organizaciones estudiantiles.</p>
                                    </div>
                            </div>
                            <br>
                            <div class="row">
                                <div style="text-align: center">
                                    ...
                                    <p>Este proyecto es parcialmente auspiciado por el <br> <a href="http://upra.edu/cic/">Centro de Investigación y Creación (CIC)</a> de UPRA <br>  y por el <a href="https://prlsamp.rcse.upr.edu/" >Puerto Rico Louis Stokes Alliance <br> For Minority Participation (PR-LSAMP)</a></p>
                                </div>
                                <div style="text-align: center">
        ...
        <div class="container">
			...
			<div class="row">
                ...
                <br>
                        ...
                        <div class="row">
                            <div style="text-align: center">
                                    <h3>Blog's de Estudiantes</h3>
                                    <a href="https://yessebellcreu.wordpress.com/">Yessebell Ríos Blog</a><br>
                                    <a href="https://bryanyomarcreu.wordpress.com/">Bryan Hernandez Blog</a><br>
                                ...
                                <div style="text-align: center">
                                    ...
                                    <p>Este proyecto es parcialmente auspiciado por el <br> <a href="http://upra.edu/cic/">Centro de Investigación y Creación (CIC)</a> de UPRA, <br>  por el  <a href="https://cra.org/cra-w/" >Computing Research Association’s Committee on <br> the Status of Women in Computing Research (CRA-W) </a> <br> y por el <a href="https://prlsamp.rcse.upr.edu/" >Puerto Rico Louis Stokes Alliance <br> For Minority Participation (PR-LSAMP)</a></p>
                                </div>
                                <div style="text-align: center">
                        ...
                        <div class="row">
                            <div style="text-align: center">
                                <div class="col-sm-6">
                                    <div style="text-align: right">
                                    <p> El objetivo de esta investigación <br>
                                        es crear una aplicación móvil para <br>
                                        encontrar salas de estudio disponibles <br>
                                        en la biblioteca de la Universidad y hacer <br>
                                        reservas.  </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-8-push">
                                    <p> Al estudiar el comportamiento de los estudiantes <br>
                                        y los regulares problemas que podrían <br>
                                        enfrentar en el proceso de hacer reservas, <br>
                                        podemos crear una interface amigable, rápida <br>
                                        para el usuario, para contrarrestar las experiencias negativas. <br> </p>
						    </div>
                        </div>
            </div>
    </div>
